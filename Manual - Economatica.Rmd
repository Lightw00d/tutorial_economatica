...
Para melhor demonstração das funcionalidades de Screenig e Matrixx, utilizaremos um caso prático, com ações da Bovespa, com exceção das financeiras, em um período de análise de 2010 à 2023, onde obteremos seu Ativo Total e seu Patrimônio Líquido. Para isso, após selecinarmos a opção de Screening, teremos a seguinte tela:
...
Após clicar em "Abrir", definremos os parâmetros da amostra desejada.
...
É possível realizar a aplicação de filtros na amostra, onde obteremos apenas os dados desejadas e apenas das empresas que são necessárias para a análise.
...
Após isso, podemos prosseguir para a elaboração do Matrixx, que pode ser feito de duas maneiras, na primeira, escolheremos item do Matrixx pelo ativo corrente. Para tal, definiremos os parâmetros desejados, no caso em questão, queremos o Ativo Total e o PL das entidades.
